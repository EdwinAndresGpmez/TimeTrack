...
class Command(BaseCommand):
    help = "Creates tenant schema and clones public tables structure for pilot migration."
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            self.style.SUCCESS(
                f"Schema '{schema}' preparado con {len(tables)} tablas clonadas desde public."
            )
        )
