...
class StatelessJWTAuthentication(BaseAuthentication):
    """
    Autenticación JWT sin consultar BD local (evita user_not_found).
    ...
    def _get_validated_token(self, raw_token: bytes):
        try:
            # valida firma/exp/nbf y deja payload accesible vía .get()
    ...
    def _build_user(self, token) -> StatelessUser:
        ...
        return StatelessUser(
            ...
            username=token.get("username") or token.get("nombre"),
