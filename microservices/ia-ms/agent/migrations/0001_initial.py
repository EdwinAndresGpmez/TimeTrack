        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "api_key",
                    models.CharField(
                        help_text="Token de GitHub, OpenAI Key, etc.", max_length=255
                    ),
                ),
                (
                    "endpoint_url",
                    models.CharField(
                        blank=True,
                        help_text="Solo si usa Azure u Ollama",
                        max_length=255,
                        null=True,
                    ),
                ),
                ...
                (
                    "temperatura",
                    models.FloatField(default=0.7, help_text="Creatividad (0.0 a 1.0)"),
                ),
