...
from .serializers import UserSerializer, CustomTokenObtainPairSerializer, MenuItemSerializer, UserAdminSerializer
...
class MisPermisosView(APIView):
    ...
    def get(self, request):
        ...
        if request.user.is_superuser:
            ...
            lista_codenames = list(PermisoVista.objects.filter(
